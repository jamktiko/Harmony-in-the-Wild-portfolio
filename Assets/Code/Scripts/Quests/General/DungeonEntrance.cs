...
public class DungeonEntrance : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            _currentQuest = QuestManager.Instance.GetQuest(_dungeonQuest);
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Trigger"))
        {
            if (_currentQuestState == QuestState.CanStart)
            {
                ...
                GameEventsManager.instance.QuestEvents.StartQuest(_dungeonQuest);
            ...
            {
                int currentQuestStepIndex = QuestManager.Instance.GetQuest(_dungeonQuest).GetCurrentQuestStepIndex();
                AbilityManager.Instance.UnlockAbility(_abilityGrantedForDungeon);
                RespawnManager.Instance.SetRespawnPosition(_respawnPoint.position);

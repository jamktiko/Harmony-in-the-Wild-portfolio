...
public class TutorialFlower : MonoBehaviour
{
    ...
    private void EnableCollection(QuestScriptableObject questObject)
    {
        if (!_canBeCollected)
        {
    ...
    private void CheckCurrentQuestStep()
    {
        ...
        int currentTutorialQuestStepIndex = QuestManager.Instance.GetQuest(_tutorialQuestSo).GetCurrentQuestStepIndex();

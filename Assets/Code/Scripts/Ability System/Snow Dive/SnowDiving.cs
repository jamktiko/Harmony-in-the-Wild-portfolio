...
public class SnowDiving : MonoBehaviour, IAbility
{
    ...
    [SerializeField] private GameObject _snowDiveVFX;
    ...
    private void ClimbSnowWall(RaycastHit hit)
    {
        ...
        if (!_isClimbing)
        {
            ...
            GameObject _snowDiveVFXInstance = Instantiate(_snowDiveVFX, FoxMovement.Instance.transform.Find("SnowDiveVFXPosition").position, Quaternion.identity);
            _snowDiveVFXInstance.GetComponent<VisualEffect>().SendEvent(_onEnableSnowDiveID);

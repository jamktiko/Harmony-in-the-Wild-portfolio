...
public class ActiveQuestUI : MonoBehaviour
{
    ...
    public void TrackQuest()
    {
        ...
        GameEventsManager.instance.QuestEvents.ShowQuestUI(
            activeQuest.Info,
            activeQuest.State == QuestState.InProgress ? activeQuest.GetCurrentQuestStepPrefab().GetComponent<QuestStep>().Objective : activeQuest.Info.Description,
            activeQuest.Info.DisplayName);

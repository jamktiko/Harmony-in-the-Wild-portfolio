...
public class QuestUI : MonoBehaviour
{
    ...
    private void InitializeQuestUI(QuestScriptableObject questObject, string description, string progress)
    {
        transform.GetChild(0).gameObject.SetActive(true);

        QuestTextComponents[0].text = ProcessTextForInputs(questObject.DisplayName);

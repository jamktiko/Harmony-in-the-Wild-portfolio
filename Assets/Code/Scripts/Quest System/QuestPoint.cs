...
public class QuestPoint : MonoBehaviour
{
    ...
    [Header("Quest")]
    [SerializeField, FormerlySerializedAs("QuestInfoForPoint")] private QuestScriptableObject _quest;
    ...
    {
        _currentQuestState = QuestManager.QuestMap[_quest].State;
    ...
    private void StartOrCompleteQuest()
    {
        ...
        {
            GameEventsManager.instance.QuestEvents.StartQuest(_quest);
        }

        else if (_playerIsNear && _readyToCompleteQuest && _currentQuestState.Equals(QuestState.CanFinish))
        {
            GameEventsManager.instance.QuestEvents.FinishQuest(_quest);
        }
    }
    ...
    public QuestScriptableObject ReturnQuestId()
    {
        return _quest;
    }

    private void SetMidQuestDialogue(QuestScriptableObject questObject, int dialogueIndex)
    {

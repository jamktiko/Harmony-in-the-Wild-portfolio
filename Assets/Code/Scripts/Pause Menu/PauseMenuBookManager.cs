...
public class PauseMenuBookManager : MonoBehaviour
{
    ...
    [FormerlySerializedAs("generalMenuPanel")]
    [SerializeField]
    public GameObject GeneralMenuPanel;

    [FormerlySerializedAs("optionsMenuPanel")]
    [SerializeField]
    public GameObject OptionsMenuPanel;

    [FormerlySerializedAs("movementControlsMenuPanel")]
    [SerializeField]
    public GameObject MovementControlsMenuPanel;

    [FormerlySerializedAs("questMenuPanel")]
    [SerializeField]
    public GameObject QuestMenuPanel;

    [SerializeField]
    public GameObject RebindControlsMenuPanel;

    [FormerlySerializedAs("gamePlayControlsMenuPanel")]
    [SerializeField]
    ...
    [FormerlySerializedAs("activeQuestPanel")]
    [SerializeField]
    public GameObject ActiveQuestPanel;

    [FormerlySerializedAs("restartQuestPanel")]
    [SerializeField]
    public GameObject RestartQuestPanel;

    [FormerlySerializedAs("exitQuestPanel")]
    [SerializeField]
    public GameObject ExitQuestPanel;

    [FormerlySerializedAs("berryPanel")]
    [SerializeField]
    public GameObject BerryPanel;

    [FormerlySerializedAs("pineConePanel")]
    [SerializeField]
    public GameObject PineConePanel;

    [FormerlySerializedAs("cinemachineFreeLook")]
    [SerializeField]
    ...
    [FormerlySerializedAs("SliderValueMaster")]
    [SerializeField]
    private float _sliderValueMaster;

    [FormerlySerializedAs("SliderValueMusic")]
    [SerializeField]
    private float _sliderValueMusic;

    [FormerlySerializedAs("SliderValue2")]
    [SerializeField]
    ...
    [FormerlySerializedAs("UIPanels")]
    [SerializeField]
    private GameObject[] _uiPanels;
    [FormerlySerializedAs("activeQuestUI")]
    [SerializeField]
